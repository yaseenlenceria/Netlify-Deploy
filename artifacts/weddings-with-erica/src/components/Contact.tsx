      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10 py-20 md:py-28 grid lg:grid-cols-2 gap-14 xl:gap-20 items-start">
        ...
        >
          ...
          <div>
            ...
            {/* WhatsApp quick-chat */}
            <a
              href="https://wa.me/353872186100?text=Hi%20Erica!%20I%20found%20you%20on%20your%20website%20and%20would%20love%20to%20chat%20about%20my%20wedding%20%F0%9F%92%9A"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-5 inline-flex items-center gap-3 px-5 py-3 border border-[#25D366]/40 text-[0.9rem] font-sans font-medium text-foreground/75 hover:border-[#25D366] hover:text-[#128C7E] transition-all group w-fit"
              aria-label="Chat with Erica on WhatsApp"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-[#25D366] shrink-0" aria-hidden="true">
              ...
              <span className="text-foreground/35 text-[0.8rem] font-light">+353 87 218 6100</span>
            </a>
          </div>
