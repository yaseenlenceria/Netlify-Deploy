    ...
    <footer className="bg-foreground text-primary-foreground">
      <div className="mx-auto px-8 md:px-12 max-w-7xl py-16 md:py-20 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
        ...
        <div className="flex flex-col gap-5">
          ...
          />
          <p className="text-primary-foreground/45 text-[0.9rem] font-light leading-[1.8] max-w-xs">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-4 pt-4 border-t border-primary-foreground/10 flex flex-col gap-1.5">
            <a href="tel:0872186100" className="text-primary-foreground/50 hover:text-primary-foreground text-[0.9rem] font-light transition-colors">
              0872186100
            </a>
            <a href="mailto:wedwitherica@gmail.com" className="text-primary-foreground/50 hover:text-primary-foreground text-[0.9rem] font-light transition-colors">
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="mx-auto px-8 md:px-12 max-w-7xl py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-[11px] text-primary-foreground/25 font-light font-sans flex items-center gap-1.5">
